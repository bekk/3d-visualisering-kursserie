...
### Bonus: Gjør mer morsomme ting med lyd (Bør gjøres etter du har gjort dag 2)

I denne oppgaven finnes det flere ting vi kan leke oss med. Her skal vi gjøre følgende for å få resultatet i bildet over:
...
Til slutt kan du parametrisere det hele ved hjelp av dat.gui. forslag til parametre: 
- Fart på rotasjon
- Baserødhet